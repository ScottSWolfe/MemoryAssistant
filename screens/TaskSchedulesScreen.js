  ...
  onCollectionUpdate = (querySnapshot) => {
    ...
    querySnapshot.forEach((doc) => {
      ...
      taskSchedules.push({
        ...
        date: firebaseHelper.changeFirestoreTimestampToDate(taskSchedule.date),
        days: taskSchedule.days,
        reminder: taskSchedule.reminder,
        reminder_time: firebaseHelper.changeFirestoreTimestampToDate(taskSchedule.reminder_time),
        ...
        notify_caregiver_time: firebaseHelper.changeFirestoreTimestampToDate(taskSchedule.notify_caregiver_time),
      });
    });
    this.setState({ 
